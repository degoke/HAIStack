...
- **Incremental refresh** uses a single `WatermarkStore` for `_since` cursors and export chaining; watermarks advance only after a successful refresh or export completes.
