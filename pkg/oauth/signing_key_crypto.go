...
// EncryptSigningKeyPEM encrypts a PEM-encoded private key with AES-GCM.
...
// DecryptSigningKeyPEM decrypts a PEM-encoded private key encrypted with EncryptSigningKeyPEM.
