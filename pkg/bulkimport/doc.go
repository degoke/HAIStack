...
// the configured object-store adapter when present, otherwise the chunked
// Postgres or SQLite blob store. Background execution integrates with pkg/jobs via TypeImportBulk.
//
