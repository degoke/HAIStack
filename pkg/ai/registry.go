...
func IsGeneric(name string) bool {
	switch name {
	case ToolReadFhirResource, ToolSearchFhirResources, ToolRunView, ToolCreateFhirResource, ToolUpdateFhirResource, ToolExecuteFhirBundle, ToolExecuteFhirTransaction:
		return true
	default:
		return false
	}
