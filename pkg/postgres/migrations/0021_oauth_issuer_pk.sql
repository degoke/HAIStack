...
ALTER TABLE hai_oauth_auth_code DROP CONSTRAINT hai_oauth_auth_code_pkey;
ALTER TABLE hai_oauth_auth_code ADD PRIMARY KEY (issuer, code);

ALTER TABLE hai_oauth_refresh_token DROP CONSTRAINT hai_oauth_refresh_token_pkey;
ALTER TABLE hai_oauth_refresh_token ADD PRIMARY KEY (issuer, token);

ALTER TABLE hai_oauth_pending_auth DROP CONSTRAINT hai_oauth_pending_auth_pkey;
