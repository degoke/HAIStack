...
CREATE TABLE IF NOT EXISTS analytics_reporting_meta (
...
CREATE TABLE IF NOT EXISTS analytics_reporting_row (
    tenant_id     TEXT NOT NULL REFERENCES tenant (id),
    view_name     TEXT NOT NULL,
    view_version  TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_analytics_reporting_row_lookup
    ON analytics_reporting_row (tenant_id, view_name, view_version);
