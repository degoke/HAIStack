...
| D | [`terminology-evaluation/`](./terminology-evaluation) | `$translate` consistency and audit provenance | `pkg/terminology`, `pkg/conceptmap`, `pkg/audit` |
...
| `make research-terminology` | Track D: gold `$translate` consistency + audit provenance |
